	            ...
	            <div class="member-detail-close">
	                ...
	                <img src="/blank/resources/images/admin/close.png" onclick="goBack();">
	           		...
	           		<div class="detail-list">
		                ...
		                <div><input type="hidden" name="no" value="${selectProject.no}"></div>
		                ...
		                <div id="detail-submit">
		                    <input type="button" value="승인" id="detail-submit-ok-btn"/>
...
<script>
	...
	// 프로젝트 승인
	$('#detail-submit-ok-btn').click(function() {
		Swal.fire({
			title: '프로젝트를 승인하시겠어요?',
			icon: 'warning',
			...
			newForm.attr("action","/blank/admin/projectApproval");
