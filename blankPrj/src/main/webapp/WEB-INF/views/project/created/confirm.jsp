...
<link rel="stylesheet" href="/blank/resources/css/created/confirm.css">
...
<body>
    ...
    $(document).ready(function() { 
        ...
        if(alertMsg != '') {
            list +=	'<div class="myprj-status">' + '<h3>' + '승인중인 프로젝트가 없습니다.' + '</h3>' + '</div>' + '</div>';
            $(".list-content").append(list);
        }else{
            list +=	'<div class="myprj-status">' + '<h3>' + $('.taps > div:nth-child(3)').text() + ' ' + "${resultcnt}" + '</h3>' + '</div>' ;
