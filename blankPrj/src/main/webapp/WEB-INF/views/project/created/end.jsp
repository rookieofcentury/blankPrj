...
<link rel="stylesheet" href="/blank/resources/css/created/end.css">
...
<body>
    ...
    $(document).ready(function() { 
        var alertMsg = '${msg}';
        if(alertMsg != '') {
            list +=	'<div class="myprj-status">' + '<h3>'  + '종료된 프로젝트가 없습니다.' + '</h3>' + '</div>' + '</div>';
            $(".list-content").append(list);
        }else{
            list +=	'<div class="myprj-status">' + '<h3>' + $('.taps > div:nth-child(6)').text() + ' ' + "${resultcnt}" + '</h3>' + '</div>' ;
