...
<link rel="stylesheet" href="/blank/resources/css/created/return.css">
...
<body>
    ...
    $(document).ready(function() { 
        var alertMsg = '${msg}';
        if(alertMsg != '') {
            list +=	'<div class="myprj-status">' + '<h3>' + '반려된 프로젝트가 없습니다.' + '</h3>' + '</div>' + '</div>';
            $(".list-content").append(list);
        }else{
            list +=	'<div class="myprj-status">' + '<h3>' + $('.taps > div:nth-child(4)').text() + ' ' + "${resultcnt}" + '</h3>' + '</div>' ;
